// 官方 drawLegend.tsx → JS（1:1）
import uniq from 'lodash/uniq.js';

export const drawLegend = (selection, { items, strokeColor, backgroundColor, legendPosition, chartWidth, chartHeight }) => {
  ...
  const backgroundWidth = Math.max(
    ...
    maxTextLength * xkcdCharWidth + colorBlockWidth + legendXPadding * 2 + 6 + (shouldDrawLogo ? legendXPadding + logoSize : 0)
  );
